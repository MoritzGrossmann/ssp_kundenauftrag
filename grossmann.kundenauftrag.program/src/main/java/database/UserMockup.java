...
public class UserMockup {
    ...
    private static final String ADMIN_USER_PASSWORD = "8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918"; //SHA-256 für admin

    private static final String USER_USER_NAME = "user";

    private static final String USER_USER_PASSWORD = "04f8996da763b7a969b1028ee3007569eaf3a635486ddab211d512c85b9df8fb"; //SHA-256 für user

    private final Map<String, UserGroup> userGroupes = new HashMap<>();
